...
trait IterableMethods[+A, +This <: IterableLike[A, This] with Iterable[A]] extends TraversableMethods[A, This]
{
  ...
  def zipAll[B, A1 >: A, That](that: Iterable[B], e1: A1, e2: B)(implicit bf: CanBuildFrom[(A1, B), That, This]): That
  def zipWithIndex[A1 >: A, That](implicit bf: CanBuildFrom[(A1, Int), That, This]): That
  def zip[A1 >: A, B, That](that: Iterable[B])(implicit bf: CanBuildFrom[(A1, B), That, This]): That
