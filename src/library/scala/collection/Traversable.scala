...
trait Traversable[+A] extends TraversableLike[A, Traversable[A]] 
  ...
  override def ++[B >: A, That](that: Traversable[B])(implicit bf: CanBuildFrom[B, That, Traversable[A]]): That
  override def ++[B >: A, That](that: Iterator[B])(implicit bf: CanBuildFrom[B, That, Traversable[A]]): That
  override def map[B, That](f: A => B)(implicit bf: CanBuildFrom[B, That, Traversable[A]]): That
  override def flatMap[B, That](f: A => Traversable[B])(implicit bf: CanBuildFrom[B, That, Traversable[A]]): That
