...
{ self =>
  ...
  override def patch[B >: A, That](from: Int, patch: Seq[B], replaced: Int)(implicit bf: CanBuildFrom[B, That, This]): That = {
...
//    else super.patch[B, That](from, patch, replaced)(bf) 
  ...
  override def padTo[B >: A, That](len: Int, elem: B)(implicit bf: CanBuildFrom[B, That, This]): That =
